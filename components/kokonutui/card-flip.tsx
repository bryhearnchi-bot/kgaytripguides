          ...
          <div className="pt-6 mt-6 border-t border-zinc-200 dark:border-zinc-800">
            ...
            >
              ...
              <div className="relative group/icon">
                ...
                />
                <ArrowRightIcon className="relative z-10 w-4 h-4 text-orange-500 transition-all duration-300 group-hover/start:translate-x-0.5 group-hover/start:scale-110" />
              </div>
            </div>
          </div>
        </div>
