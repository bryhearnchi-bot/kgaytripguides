...
export function ImageUploadPopup({
  ...
  return (
    <AdminBottomSheet
      ...
      description="Choose how you want to upload your image"
      maxHeight="60vh"
      className="z-[10002]"
    >
      {/* Upload Progress */}
      ...
      <div className="space-y-4">
        ...
        <button
          ...
          className="w-full p-4 border-2 border-dashed border-white/20 rounded-xl hover:border-blue-400/50 hover:bg-blue-500/5 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
        >
