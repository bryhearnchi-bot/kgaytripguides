...
import { Users, Ship, Calendar, TrendingUp, Activity, Plus, Clock, Star } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <section className="rounded-2xl border border-white/10 bg-white/5/80 shadow-2xl shadow-black/40 backdrop-blur">
          ...
          <div className="p-6 grid grid-cols-2 gap-3">
            <Button
              variant="ghost"
              className="justify-start rounded-full border border-white/10 bg-white/5 px-4 py-2 text-white/80 hover:bg-white/10"
            >
