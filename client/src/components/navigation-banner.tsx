      ...
      <div className="text-white fixed z-[60] w-full top-0 left-0 right-0 pt-[env(safe-area-inset-top)] bg-white/10 backdrop-blur-lg">
        <div className="px-3 sm:px-4 lg:px-8 py-2 flex items-center justify-between">
          ...
          <button
            ...
            className={cn(
              'px-3 py-2 rounded-full text-sm font-semibold transition-all duration-300 ease-in-out flex items-center justify-center gap-2',
              activeTab === 'mystuff' ? 'bg-white/70 text-black' : 'text-white/70 hover:text-white'
            )}
          >
          ...
          <button
            ...
            className={cn(
              'px-3 py-2 rounded-full text-sm font-semibold transition-all duration-300 ease-in-out flex items-center justify-center gap-2',
              activeTab === 'alerts' ? 'bg-white/70 text-black' : 'text-white/70 hover:text-white'
            )}
          >
          ...
          <button
            ...
            className={cn(
              'px-3 py-2 rounded-full text-sm font-semibold transition-all duration-300 ease-in-out flex items-center justify-center gap-2',
              activeTab === 'settings' ? 'bg-white/70 text-black' : 'text-white/70 hover:text-white'
            )}
          >
            <User
              className={cn(
                'w-4 h-4 flex-shrink-0',
                activeTab === 'settings' && user ? 'fill-black stroke-black' : user ? 'fill-blue-600 stroke-blue-600' : ''
              )}
            />
            <span>Settings</span>
          </button>
