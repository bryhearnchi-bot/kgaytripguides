...
import { Globe, Youtube, Linkedin, Link } from 'lucide-react';
...
/**
 * Get the appropriate social media icon for a given platform
 */
export function getSocialIcon(platform: string, className = 'w-5 h-5'): React.ReactNode {
  switch (platform.toLowerCase()) {
    ...
    case 'linktree':
      return <LinktreeIcon className={className} />;
    case 'website':
