  ...
  return (
    <PopoverPrimitive.Portal container={container}>
      <PopoverPrimitive.Content
        ...
        className={cn(
          'z-[100] w-72 rounded-md border border-white/10 bg-white/15 backdrop-blur-xl p-4 text-white shadow-md outline-none pointer-events-auto data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 origin-[--radix-popover-content-transform-origin]',
          className
        )}
        aria-hidden={false}
        {...props}
