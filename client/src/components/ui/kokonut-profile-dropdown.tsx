...
import { LogOut, User, Shield, ChevronDown, Edit } from 'lucide-react';
...
export default function KokonutProfileDropdown({
  ...
  // Add Edit Trip menu item if on a trip page and user can edit
  if (
    showEditTrip &&
    onEditTrip &&
  ...
  const handleMenuClick = (item: MenuItem) => {
    if (item.label === 'Edit Trip' && onEditTrip) {
      onEditTrip();
      setIsOpen(false);
    } else {
