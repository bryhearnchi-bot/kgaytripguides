  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: cn(
          'space-y-4 flex flex-col justify-center min-h-[280px]',
          isCompact && '!space-y-2 w-full min-h-[200px]'
        ),
        caption: cn(
        ...
        cell: cn(
          ...
          isCompact
            ? 'w-auto focus-within:relative focus-within:z-20'
            : 'h-9 w-9 text-sm focus-within:relative focus-within:z-20'
        ),
        day: cn(
          buttonVariants({ variant: 'ghost' }),
          isCompact
            ? 'w-full h-full aspect-square p-0 text-[0.75rem] leading-none font-normal text-white/90 hover:bg-white/10 hover:text-white aria-selected:opacity-100 pointer-events-auto cursor-pointer min-h-[1.5rem] flex items-center justify-center'
            : 'h-9 w-9 p-0 text-sm font-normal text-white/90 hover:bg-white/10 hover:text-white aria-selected:opacity-100 pointer-events-auto cursor-pointer'
        ),
        day_range_end: 'day-range-end',
        day_selected:
          'bg-white/20 text-white hover:bg-white/30 hover:text-white focus:bg-white/20 focus:text-white rounded-full border-2 border-white',
        day_today: 'text-[#60a5fa] font-semibold bg-transparent hover:bg-white/10',
        day_outside:
