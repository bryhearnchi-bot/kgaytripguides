...
export const OverviewTab = memo(function OverviewTab({
  ...
  const toggleShipInfo = () => {
    console.log('Toggle ship info clicked, current state:', isShipExpanded);
    haptics.light();
    setIsShipExpanded(prev => {
      console.log('Setting ship expanded to:', !prev);
      return !prev;
    });
  };
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-4">
      ...
      {/* Mobile: Single column with custom order, Desktop: 3-column grid */}
      <div className="flex flex-col lg:grid lg:grid-cols-3 gap-4">
        {/* Trip Statistics - Desktop/iPad only (at top of left column) */}
        <div className="hidden lg:block bg-white/10 border border-white/20 rounded-xl p-3 md:p-4 shadow-lg lg:col-span-2">
        ...
        {/* Updates - Mobile: 1st, Desktop: Right column row 2 */}
        <div className="order-1 lg:order-none bg-white/10 border border-white/20 rounded-xl p-4 shadow-lg flex-1 lg:col-span-1 lg:row-start-2">
        ...
        {/* About This Trip - Mobile: 2nd, Desktop: Left column row 2 */}
        <div className="order-2 lg:order-none bg-white/10 border border-white/20 rounded-xl p-4 shadow-lg lg:col-span-2 lg:row-start-2">
          <div className="flex items-center space-x-2 mb-3">
        ...
        {/* Ship Details - Mobile: 3rd (collapsible), Desktop: Left column row 3 */}
        <div className="order-3 lg:order-none bg-white/10 border border-white/20 rounded-xl shadow-lg p-4 md:p-6 lg:col-span-2 lg:row-start-3">
          {/* Ship Header */}
          <div className="flex items-center space-x-2 mb-3">
        ...
        {/* Cruise Route - Mobile: 4th, Desktop: Right column row 3 */}
        <div className="order-4 lg:order-none bg-white/10 border border-white/20 rounded-xl p-4 shadow-lg lg:col-span-1 lg:row-start-3">
          <div className="flex items-center space-x-2 mb-3">
