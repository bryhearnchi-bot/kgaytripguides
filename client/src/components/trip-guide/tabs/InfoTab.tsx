  ...
  return (
    <div className="max-w-6xl mx-auto space-y-4">
      <div className="flex items-center space-x-2 mb-2 -mt-2">
        ...
        <h2 className="text-lg font-bold text-white/90 tracking-wide uppercase">Important Information</h2>
      </div>
            ...
            <div className="p-4">
              <ul className="space-y-2">
                {IMPORTANT_INFO.firstDayTips.map((tip, index) => (
                  ...
                  >
                    <Badge variant="secondary" className="bg-ocean-100 text-ocean-700 mt-0.5 flex-shrink-0">
                      {index + 1}
                    </Badge>
            ...
            <div className="p-4 space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">{IMPORTANT_INFO.entertainment.bookingStart}</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">{IMPORTANT_INFO.entertainment.standbyRelease}</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">{IMPORTANT_INFO.entertainment.rockstarSuites}</p>
                </div>
              </div>
            </div>
          </Card>
              ...
              <div className="p-4 space-y-3">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{IMPORTANT_INFO.virginApp.registrationSteps} steps to complete</p>
                  </div>
                </div>
