...
export const ITINERARY: ItineraryStop[] = [
  ...
  },
  {
    key: '2025-08-21',
    date: 'Thu, Aug 21',
    port: 'Athens, Greece (Embarkation Day)',
    arrive: '—',
    depart: '6:00 PM',
  },
  {
  ...
  },
  {
    key: '2025-08-31',
    date: 'Sun, Aug 31',
    port: 'Athens, Greece (Disembarkation Day)',
    arrive: '7:00 AM',
    depart: '—',
  },
];
    ...
    items: [
      {
        ...
        venue: 'Academias Hotel RoofTop Bar',
      },
    ],
  },
  {
    ...
    items: [
      ...
      { type: 'show', time: '21:00', title: 'Rob Houchen', venue: 'The Manor' },
      {
        type: 'show',
        time: '23:00',
        title: 'Gay Comedy Stars (Brad Loekle, Rachel Scanlon, Daniel Webb)',
        venue: 'The Manor',
      },
  ...
  },
  {
    ...
    items: [
      ...
      { type: 'show', time: '21:00', title: 'Rob Houchen', venue: 'The Manor' },
      {
        type: 'show',
        time: '23:00',
        title: 'Gay Comedy Stars (Rachel Scanlon, Daniel Webb)',
        venue: 'The Manor',
      },
      { type: 'party', time: '23:00', title: 'Lost At Sea', venue: 'Aquatic Club' },
      {
        type: 'lounge',
        time: '23:00',
        title: 'Piano Bar with William TN Hall',
        venue: 'On the Rocks',
      },
    ],
  },
  {
    ...
    items: [
      ...
      { type: 'show', time: '23:00', title: 'Rob Houchen', venue: 'The Manor' },
      {
        type: 'lounge',
        time: '23:00',
        title: 'Piano Bar with Brandon James Gwinn',
        venue: 'On the Rocks',
      },
  ...
  },
  {
    ...
    items: [
      ...
      { type: 'show', time: '19:00', title: 'Leona Winter', venue: 'The Manor' },
      {
        type: 'show',
        time: '21:00',
        title: 'Comedy All-Stars (Brad Loekle, Rachel Scanlon, Daniel Webb)',
        venue: 'The Manor',
      },
      { type: 'show', time: '23:00', title: 'Sherry Vine', venue: 'The Manor' },
      {
  ...
  },
  {
    ...
    items: [
      ...
      { type: 'show', time: '23:00', title: 'Sherry Vine', venue: 'The Manor' },
      {
        type: 'party',
        time: '23:00',
        title: 'Greek Isles: Here We Go Again!',
        venue: 'Aquatic Club',
      },
    ],
  },
    ...
    items: [
      {
        type: 'party',
        time: '17:00',
        title: 'Revival! Classic Disco T-Dance',
        venue: 'Aquatic Club',
      },
      { type: 'show', time: '19:00', title: 'Alexis Michelle', venue: 'The Manor' },
      { type: 'show', time: '21:00', title: 'Alyssa Wray', venue: 'The Manor' },
...
export const CITY_ATTRACTIONS: CityAttraction[] = [
  {
    city: 'Athens, Greece',
    topAttractions: ['Acropolis & Parthenon', 'Acropolis Museum', 'Plaka District'],
    otherThingsToDo: ['Panathenaic Stadium', 'Mount Lycabettus', 'Local tavernas in Monastiraki'],
    gayBars: [
  ...
  },
  {
    ...
    otherThingsToDo: ['Boat trip to the volcano', 'Wine tasting tours', 'Hike from Fira to Oia'],
    gayBars: [
  ...
  },
  {
    ...
    topAttractions: ['Ancient City of Ephesus', 'Pigeon Island (Kusadasi Castle)', 'Ladies Beach'],
    otherThingsToDo: [
  ...
  },
  {
    ...
    topAttractions: ['Hagia Sophia', 'Blue Mosque', 'Topkapi Palace'],
    otherThingsToDo: ['Grand Bazaar shopping', 'Spice Market', 'Bosphorus cruise'],
    gayBars: [
  ...
  },
  {
    ...
    otherThingsToDo: ['Elia Beach', 'Paraportiani Church', 'Nightlife & sunset bars'],
    gayBars: [
