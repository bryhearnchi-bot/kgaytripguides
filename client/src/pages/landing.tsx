...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-ocean-600 via-ocean-500 to-ocean-400">
      {/* Header */}
      <header className="cruise-gradient wave-pattern text-white fixed top-0 left-0 right-0 z-40 bg-ocean-600 opacity-100 pt-[21px] pb-[30px]">
      ...
      {/* Main Content */}
      <div className="max-w-7xl mx-auto px-4 pt-[67px] pb-[2px]">
        {/* Filtered Trips */}
