...
import PortManagement from '@/components/admin/PortManagementSafe'; // Using safe version to debug white screen
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsList className="grid w-full grid-cols-3 md:grid-cols-7 mb-8">
            ...
            <TabsTrigger value="party" className="flex items-center space-x-2">
              ...
              <span className="hidden sm:inline">Party Management</span>
